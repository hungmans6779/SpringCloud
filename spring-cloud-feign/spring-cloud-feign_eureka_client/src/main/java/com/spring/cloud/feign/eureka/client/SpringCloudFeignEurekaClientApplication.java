 ...
 *  </pre>
 */
package com.spring.cloud.feign.eureka.client;
...
public class SpringCloudFeignEurekaClientApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringCloudFeignEurekaClientApplication.class, args);
	}
